...
<html>
    <head>
        ...
        <!--<link rel="stylesheet" href="/fw/node_modules/layui-src/dist/css/layui.css">-->
    </head>
    <style>
	    .beauty_mdui{
	        padding-left: 5%;
    ...
    <!--<script src="/fw/node_modules/layui-src/dist/layui.js"></script>-->
    <body class="mdui-appbar-with-toolbar mdui-theme-primary-green mdui-theme-accent-pink mdui-loaded" style="background: url('https://www.toptal.com/designers/subtlepatterns/patterns/checkerboard-cross.png');" id="pjax-body">
        ...
        <div class="beauty_mdui" id="pjax-change"></div>
        <br><br>
        <div id="copyright" class="mdui-typo"></div>
    </body>
    <script src="http://sv.bsot.cn:5000/copyright/?date=2020&name=cxbsoft&link=http://blog.bsot.cn"></script>
    <script>
